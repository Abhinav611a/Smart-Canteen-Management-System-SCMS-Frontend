  ...
  useEffect(() => {
    const completeGoogleLogin = async () => {
      ...
      try {
        ...
        if (!user) {
          throw new Error('Unable to fetch user after Google sign-in')
        }
    ...
    <div className="min-h-screen bg-mesh-light dark:bg-mesh-dark flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="glass-card p-6 sm:p-8">
          ...
          {googleLoading && (
            <div className="mb-4 rounded-lg border border-brand-300 bg-brand-50 px-4 py-3 text-sm text-brand-700 dark:border-brand-700 dark:bg-brand-900/20 dark:text-brand-300">
